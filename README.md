...
- **단독 기기** — 랙에 물리지 않고 혼자 소리를 내는 두 대: **Victor V 축음기**(1907, 어쿠스틱 — 태엽·강철 바늘·놋쇠 나팔관)와 **금성 A-501 라디오**(1959, 국산 1호 5구 진공관). 고르면 랙 여섯 유닛이 화면에서 내려가고 오디오도 EQ·앰프를 건너뛰어 기기 고유의 음향 경로로만 흐른다
